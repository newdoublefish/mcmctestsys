...
//----------------------------------------------------------------------------
// Resource tracking functions are undocumented exports of the runtime engine.
//----------------------------------------------------------------------------
...
static char *CVIXML_FORMAT_NEW_DOC      = "Document 0x%08x with root '%s'";
static char *CVIXML_FORMAT_LOAD_DOC     = "Document 0x%08x from file '%s'";
static char *CVIXML_FORMAT_ELEMENT      = "Element 0x%08x";
static char *CVIXML_FORMAT_NAMED_ELEM   = "Element 0x%08x '%s'";
static char *CVIXML_FORMAT_ATTRIBUTE    = "Attribute 0x%08x";
static char *CVIXML_FORMAT_NAMED_ATTR   = "Attribute 0x%08x '%s'";
static char *CVIXML_FORMAT_DOC_HANDLE   = "ActiveX document 0x%08x";
static char *CVIXML_FORMAT_ELEM_HANDLE  = "ActiveX element 0x%08x";
static char *CVIXML_FORMAT_ATTR_HANDLE  = "ActiveX attribute 0x%08x";
#endif /* def _CVI_ */
...
CVIXMLStatus CVIFUNC CVIXMLLoadDocument (const char *fullPath, CVIXMLDocument *doc)
{
    ...
    *doc = (CVIXMLDocument)docPtr;
    ...
    __CVI_Resource_Acquire ((void *)*doc, CVIXML_RESOURCE_TYPE,
        CVIXML_FORMAT_LOAD_DOC, *doc, fullPath);
#endif /* def _CVI_ */
Error:
#ifdef _CVI_
    SetEnableResourceTracking (tracking);
                                        ...
                                        CVIXMLDocument *doc)
{
    ...
    *doc = (CVIXMLDocument)docPtr;
    ...
    SetEnableResourceTracking (tracking);
    __CVI_Resource_Acquire ((void *)*doc, CVIXML_RESOURCE_TYPE,
        CVIXML_FORMAT_NEW_DOC, *doc, rootElementName);
#endif /* def _CVI_ */
Error:
#ifdef _CVI_
    SetEnableResourceTracking (tracking);
                                       ...
                                       const char *tag, CVIXMLElement *elem)
{
    ...
    *elem = (CVIXMLElement)elemPtr;
    ...
    SetEnableResourceTracking (tracking);
    __CVI_Resource_Acquire ((void *)*elem, CVIXML_RESOURCE_TYPE,
        CVIXML_FORMAT_NAMED_ELEM, *elem, tag);
#endif /* def _CVI_ */
Error:
#ifdef _CVI_
    SetEnableResourceTracking (tracking);
                                        ...
                                        CVIXMLElement *destElem)
{
    ...
    *destElem = (CVIXMLElement)newElemPtr;
    ...
    __CVI_Resource_Acquire ((void *)*destElem, CVIXML_RESOURCE_TYPE,
        CVIXML_FORMAT_ELEMENT, *destElem);
#endif /* def _CVI_ */
Error:
#ifdef _CVI_
    SetEnableResourceTracking (tracking);
                                                   ...
                                                   CVIXMLElement *child)
{
    ...
    *child = (CVIXMLElement)childElemPtr;
    ...
    __CVI_Resource_Acquire ((void *)*child, CVIXML_RESOURCE_TYPE,
        CVIXML_FORMAT_ELEMENT, (void *)*child);
#endif /* def _CVI_ */
Error:
#ifdef _CVI_
    SetEnableResourceTracking (tracking);
                                                 ...
                                                 CVIXMLElement *child)
{
    ...
    *child = 0;
    ...
    SetEnableResourceTracking (tracking);
    __CVI_Resource_Acquire ((void *)*child, CVIXML_RESOURCE_TYPE,
        CVIXML_FORMAT_NAMED_ELEM, (void *)*child, tag);
#endif /* def _CVI_ */
Error:
#ifdef _CVI_
    SetEnableResourceTracking (tracking);
...
CVIXMLStatus CVIFUNC CVIXMLGetNextElement (CVIXMLElement elem, CVIXMLElement *sibElem)
{
    ...
    *sibElem = 0;
    ...
    __CVI_Resource_Acquire ((void *)*sibElem, CVIXML_RESOURCE_TYPE,
        CVIXML_FORMAT_ELEMENT, (void *)*sibElem);
#endif /* def _CVI_ */
Error:
#ifdef _CVI_
    SetEnableResourceTracking (tracking);
...
CVIXMLStatus CVIFUNC CVIXMLGetParentElement (CVIXMLElement child, CVIXMLElement *parent)
{
    ...
    *parent = 0;
    ...
    __CVI_Resource_Acquire ((void *)*parent, CVIXML_RESOURCE_TYPE,
        CVIXML_FORMAT_ELEMENT, (void *)*parent);
#endif /* def _CVI_ */
Error:
#ifdef _CVI_
    SetEnableResourceTracking (tracking);
                                                ...
                                                CVIXMLAttribute *attr)
{
    ...
    *attr = (CVIXMLAttribute)attrPtr;
    ...
    __CVI_Resource_Acquire ((void *)*attr, CVIXML_RESOURCE_TYPE,
        CVIXML_FORMAT_ATTRIBUTE, (void *)*attr);
#endif /* def _CVI_ */
Error:
#ifdef _CVI_
    SetEnableResourceTracking (tracking);
                                               ...
                                               CVIXMLAttribute *attr)
{
    ...
    *attr = 0;
    ...
    SetEnableResourceTracking (tracking);
    __CVI_Resource_Acquire ((void *)*attr, CVIXML_RESOURCE_TYPE,
        CVIXML_FORMAT_NAMED_ATTR, (void *)*attr, name);
#endif /* def _CVI_ */
Error:
#ifdef _CVI_
    SetEnableResourceTracking (tracking);
                                             ...
                                             CVIXMLAttribute *sibAttr)
{
    ...
    *sibAttr = 0;
    ...
    __CVI_Resource_Acquire ((void *)*sibAttr, CVIXML_RESOURCE_TYPE,
        CVIXML_FORMAT_ATTRIBUTE, (void *)*sibAttr);
#endif /* def _CVI_ */
Error:
#ifdef _CVI_
    SetEnableResourceTracking (tracking);
                                                     ...
                                                     MSXMLObj_IXMLDOMDocument *xmlHdl)
{
    ...
    __CVI_Resource_Acquire ((void *)*xmlHdl, CVIXML_RESOURCE_TYPE,
        CVIXML_FORMAT_DOC_HANDLE, (void *)*xmlHdl);
#endif /* def _CVI_ */
Error:
#ifdef _CVI_
    SetEnableResourceTracking (tracking);
                                                    ...
                                                    MSXMLObj_IXMLDOMElement *elemHdl)
{
    ...
    __CVI_Resource_Acquire ((void *)*elemHdl, CVIXML_RESOURCE_TYPE,
        CVIXML_FORMAT_ELEM_HANDLE, (void *)*elemHdl);
#endif /* def _CVI_ */
Error:
#ifdef _CVI_
    SetEnableResourceTracking (tracking);
                                                      ...
                                                      MSXMLObj_IXMLDOMAttribute *attrHdl)
{
    ...
    __CVI_Resource_Acquire ((void *)*attrHdl, CVIXML_RESOURCE_TYPE,
        CVIXML_FORMAT_ATTR_HANDLE, (void *)*attrHdl);
#endif /* def _CVI_ */
Error:
#ifdef _CVI_
    SetEnableResourceTracking (tracking);
