...
#define  SET_PANEL_AUTOSAVE               10      /* control type: radioButton, callback function: (none) */
#define  SET_PANEL_RELAY_ENABLE           11      /* control type: radioButton, callback function: (none) */
