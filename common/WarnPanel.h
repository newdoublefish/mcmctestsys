...
#define  MANUALTIPS_TIMER                 5       /* control type: timer, callback function: (none) */
#define  MANUALTIPS_TIMERSTR              6       /* control type: textMsg, callback function: (none) */
#define  MANUALTIPS_BACKGROUD             7       /* control type: textMsg, callback function: (none) */
